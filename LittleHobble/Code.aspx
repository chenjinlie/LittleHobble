<%@ Page Title="" Language="C#" MasterPageFile="~/title.Master" AutoEventWireup="true" CodeBehind="Code.aspx.cs" Inherits="LittleHobble.Code" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="content">
        <asp:Repeater ID="Repeater_title" runat="server">
            <HeaderTemplate>
                <div id="content_box">
                    <h1 style="margin-top: 50%; text-align: center;">代码文章</h1>
            </HeaderTemplate>
            <ItemTemplate>
                <dl>
                    <dd>
                    ...
                    <dt>
                        ...
                        <br />
                        <img src="../../Image/作者.png" />&nbsp;&nbsp;<%#Eval("UserName") %><br /><div style="font-weight: 400; color: #808080; margin-top: 2%;"><%#Eval("ArticleDescription") %></div>
                    </dt>
                </dl>
            </ItemTemplate>
            <FooterTemplate>
